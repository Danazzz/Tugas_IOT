jQuery( document ).ready(function() {
    ...
    client = new Paho.MQTT.Client("broker.hivemq.com", 8000,"Kelompok7_WebIface");
    ...
    function onConnect() {
        ...
        client.subscribe("undiknas/ti/kelompok7/relay");
        client.subscribe("undiknas/ti/kelompok7/relay/state");
        client.subscribe("undiknas/ti/kelompok7/sensor/suhu");
    ...
    function onMessageArrived(message) {
        ...
        if(message.destinationName == "undiknas/ti/kelompok7/sensor/suhu"){
        ...
        else if(message.destinationName == "undiknas/ti/kelompok7/relay/state"){
    ...
    $('#fan-on').click(function(){
        ...
        message.destinationName = "undiknas/ti/kelompok7/relay";
        client.send(message);
    });
